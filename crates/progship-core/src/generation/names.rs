...
static GIVEN_NAMES: &[&str] = &[
    ...
    "Wei", "Yuki", "Aisha", "Pavel", "Ingrid", "Carlos", "Fatima", "Kenji",
    "Olga", "Raj", "Amara", "Dmitri", "Elena", "Hassan", "Priya", "Sven",
    "Ming", "Akiko", "Omar", "Katya", "Diego", "Nadia", "Hiroshi", "Leila",
    // Sci-fi appropriate
    "Zara", "Orion", "Nova", "Phoenix", "Atlas", "Luna", "Sirius", "Aurora",
    "Vega", "Lyra", "Cassius", "Thea", "Juno", "Felix", "Sage", "River",
];
...
static FAMILY_NAMES: &[&str] = &[
    ...
    // International variety
    "Chen", "Nakamura", "Patel", "Ivanov", "Mueller", "Garcia", "Kim", "Okonkwo",
    "Johansson", "Ali", "Petrov", "Nguyen", "Kowalski", "Santos", "Yamamoto", "Singh",
    "Zhang", "Tanaka", "Hassan", "Volkov", "Rodriguez", "Park", "Sato", "Ahmed",
    // Compound/hyphenated
    "O'Brien", "Van der Berg", "De Silva", "Al-Rashid", "Mc'Neill", "St. Claire",
];
