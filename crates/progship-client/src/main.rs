    ...
    for room in conn.db.room().iter() {
        ...
        spawn_wall_with_gaps(
            ...
            WallParams {
                ...
                wall_thickness,
                horizontal: true,
                door_positions: &north_pos,
                room_center: room.x,
                door_widths: &north_widths,
                room_id: room.id,
                deck: room.deck,
            },
        );
        ...
        spawn_wall_with_gaps(
            ...
            WallParams {
                ...
                wall_thickness,
                horizontal: true,
                door_positions: &south_pos,
                room_center: room.x,
                door_widths: &south_widths,
                room_id: room.id,
                deck: room.deck,
            },
        );
        ...
        spawn_wall_with_gaps(
            ...
            WallParams {
                ...
                wall_thickness,
                horizontal: false,
                door_positions: &east_pos,
                room_center: room.y,
                door_widths: &east_widths,
                room_id: room.id,
                deck: room.deck,
            },
        );
        ...
        spawn_wall_with_gaps(
            ...
            WallParams {
                ...
                wall_thickness,
                horizontal: false,
                door_positions: &west_pos,
                room_center: room.y,
                door_widths: &west_widths,
                room_id: room.id,
                deck: room.deck,
            },
        );
...
// Bevy system with many resources - grouping would reduce clarity
