...
pub trait tick {
    ...
    fn tick(&self, delta_seconds: f32) -> __sdk::Result<()>;
...
impl tick for super::RemoteReducers {
    fn tick(&self, delta_seconds: f32) -> __sdk::Result<()> {
        self.imp.call_reducer("tick", TickArgs { delta_seconds })
    }
    fn on_tick(
        &self,
        ...
        TickCallbackId(self.imp.on_reducer(
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                let super::ReducerEventContext {
                    event:
                        __sdk::ReducerEvent {
                            reducer: super::Reducer::Tick { delta_seconds },
                            ..
                        },
                    ..
                } = ctx
