//! Door placement rules and connectivity logic.
//!
//! Functions for determining when rooms should have direct doors between them.
...
pub fn should_have_room_door(a: u8, b: u8) -> bool {
